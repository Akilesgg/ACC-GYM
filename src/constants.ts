export const INITIAL_SPORTS = [
  { name: "Musculación", icon: "Dumbbell", category: "Fuerza", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=400&auto=format&fit=crop", subtypes: ["Hipertrofia", "Fuerza Máxima", "Resistencia Muscular", "Powerlifting"] },
  { name: "Ciclismo", icon: "Bike", category: "Cardio", imageUrl: "https://images.unsplash.com/photo-1517649763962-0c623066013b?q=80&w=400&auto=format&fit=crop", subtypes: ["Carretera", "Montaña (MTB)", "Indoor/Spinning", "Gravel"] },
  ...
  { name: "Running", icon: "Footprints", category: "Cardio", imageUrl: "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?q=80&w=400&auto=format&fit=crop", subtypes: ["Asfalto", "Trail Running", "Pista", "Cinta"] },
  ...
  { name: "Fútbol", icon: "Activity", category: "Equipo", imageUrl: "https://images.unsplash.com/photo-1508098682722-e99c43a406b2?q=80&w=400&auto=format&fit=crop" },
